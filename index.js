...
//▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣(Herman Chanel)▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣//
botname = "友Abyss Bot"
owner = ["6282262572982@s.whatsapp.net","6282124032963@s.whatsapp.net"];
name = "Hermansyah"
premium = ["6282262572982@s.whatsapp.net","6282124032963@s.whatsapp.net"];
battery = {
...
const  tonMsg = (text, footer, but = [], options = {}) => {
...
├ *pulsa* :082124032963
`
        herman.sendMessage(from, fs.readFileSync("./media/herman.webp"), image, {quoted: fvideo, caption:donate})
...
`
        herman.sendMessage(from, fs.readFileSync("./media/herman.webp"), image, {quoted: fvideo, caption: medsos})
      }   
      switch(command){
      case 'mode':
...
//▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣(Herman Chanel)▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣//
          ...
          case 'facebook':
              ...
              reply(mess.wait)
              data = await fetchJson(`https://api.lolhuman.xyz/api/facebook?apikey=44331e566f11203b89e75428&url=${args[0]}`)
...
gambar = fs.readFileSync('./media/herman.webp')
...
case 'wetglass'://Herman Chanel
                ...
                case 'freefire':
                    ...
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/ephoto1/${command}?apikey=herman.sendMessage44331e566f11203b89e75428&text=${ini_txt}`)
...
ini_txt = args.join(" ")
getBuffer(`http://api.lolhuman.xyz/api/textprome/${command}?apikey=herman.sendMessage44331e566f11203b89e75428&text=${ini_txt}`).then((gambar) => {
...
case 'shadow'://Herman Chanel
                ...
                case 'carvedwood':
                    if (args.length == 0) return reply(`Teksnya Mana ?\nContoh : ${prefix + command} herman Chanel`)
ini_txt = args.join(" ")
getBuffer(`http://api.lolhuman.xyz/api/photooxy1/${command}?apikey=herman.sendMessage44331e566f11203b89e75428&text=${ini_txt}`).then((gambar) => {
herman.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Done Subscribe Herman Chanel`, quoted : ftrol})
})
break
case 'suit':
